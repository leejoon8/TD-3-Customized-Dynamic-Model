...
start_timesteps = 1e4
eval_freq  = 5e3
max_timesteps = 9e5 #Total number of iterations/timesteps
save_models = True
expl_noise = 0.1
batch_size = 100
...
plt.xlabel('Episodes')
plt.ylabel('Reward')
plt.title('Reward Curve: TD-3 AntRobot')
plt.savefig('images/AntRobot9e5del2.png',dpi=300)
plt.show()
##################################################
...
plt.title('Average Reward Curve: TD-3 AntRobot')
plt.savefig('images/AntRobot9e5Avrdel2.png',dpi=300)
plt.show()
######################################
######################################
"""
